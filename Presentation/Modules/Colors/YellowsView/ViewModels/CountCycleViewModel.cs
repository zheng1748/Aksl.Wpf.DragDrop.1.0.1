...
namespace Aksl.Modules.FlowControls.ViewModels
{
    public class CountCycleViewModel : BindableBase, INavigationAware
    {
        #region Members
        #endregion

        #region Constructors
        public CountCycleViewModel()
        {
